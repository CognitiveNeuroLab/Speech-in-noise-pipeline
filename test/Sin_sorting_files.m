...
A=importPresentationLog([dir subject_name{:} name_sin_logfile num2str(blocks) '.txt']);%this is normally .log, but due to deindentifying the files, they got saves as .txt, outcome is the same. 
